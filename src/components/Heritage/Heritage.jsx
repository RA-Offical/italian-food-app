		...
		<section className="bg-red-100">
			<Container classes={"py-24  relative"}>
				...
				<div className="py-3 mt-10">
					<p className="md:max-w-prose md:mx-auto md:text-center before:content-[open-quote] before:text-2xl before:mr-1 after:content-[close-quote] after:text-2xl after:ml-1">
